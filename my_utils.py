...
if __name__ == "__main__":
    ...
    test_parse_os_release('./test/etc/os-release-regular')
    test_parse_os_release('./test/etc/os-release-edu')
    test_parse_os_release('./test/etc/os-release-wsk')
    test_parse_os_release('./test/etc/os-release-server-v')
    test_parse_os_release('./test/etc/os-release-xxx')
